<!--
  Source: ML Challenge 2026 organiser problem statement (student_resource/README.md),
  added to this repo on 2026-09-25. Kept verbatim: do not edit. If the organisers
  publish an update, replace this file and update the date above.
  Paths below (dataset/, utils/, output/) are relative to the organiser bundle,
